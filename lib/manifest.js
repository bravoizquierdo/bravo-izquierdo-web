...
(function () {
  ...
  window.__BRAND__ = {
    ...
    // de las planillas CSV. Si quedan vacíos, se usan los respaldos locales.
    onedrive: {
      noticias: "",   // ← vínculo de noticias.csv en OneDrive
      proyectos: ""   // ← vínculo de proyectos.csv en OneDrive
    },
    respaldos: {
      noticias: "data/noticias.csv",
